// Création d'un profil enfant : prénom + choix de l'avatar chat-sushi.
// En v1 (pilote CP), le niveau est fixé au CP — les autres niveaux arriveront
// avec leur contenu (Phase 7).
...
export function ProfileCreate() {
  ...
  const submit = (e: FormEvent) => {
    e.preventDefault()
    if (!trimmed) return
    void addProfile({ name: trimmed, character, level: 'cp' })
  }
