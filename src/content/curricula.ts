...
import cm2Data from './curriculum/cm2.json'
...
export const cm2: Curriculum = curriculumSchema.parse(cm2Data)

// Tout le primaire (CP → CM2) est désormais couvert.
export const CURRICULA = { cp, ce1, ce2, cm1, cm2 } satisfies Partial<Record<LevelId, Curriculum>>
